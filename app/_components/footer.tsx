...
const Footer = () => {
    return (
        <div id="contact" className='bg-[#FFA400] min-h-[35vh] flex flex-col items-center w-full md:flex-row md:pl-8 pt-16 md:pt-0'>
            <div className='flex flex-col md:w-1/3'>
                ...
                <a className='mt-8 text-lg' href="https://www.instagram.com/heliconiaprojects/" target='_blank'>
                    INSTAGRAM
                </a>
            </div>
